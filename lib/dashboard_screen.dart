      ...
      child: FadeIn(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Analyzed messages', style: theme.textTheme.caption),
          ],
        ),
      ),
    );
        ...
        if (label == 'Sync now') {
          AwesomeNotifications().createNotification(
              content: NotificationContent(
                  ...
                  title: 'Alert! ',
                  body:
                      'In section Warning Messages, there are suspicious messages you can check',
                  notificationLayout: NotificationLayout.BigText));
        } else if (label == 'My sons') {
          Navigator.of(context).push(FadePageRoute(
            builder: (context) => const SonsScreen(),
          ));
        } else if (label == 'Warning Messages') {
          Navigator.of(context).push(FadePageRoute(
